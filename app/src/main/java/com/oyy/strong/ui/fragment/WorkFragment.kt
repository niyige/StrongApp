...
import kotlinx.android.synthetic.main.fragment_work_layout.*
...
class WorkFragment : BaseV4Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        var view: View? = null
        if (inflater != null) {
            view = inflater.inflate(R.layout.fragment_work_layout, null)
    ...
    private fun initClick() {
        ...
        submitBtn.onClick {
            ...
            if (TextUtils.isEmpty(a1) || TextUtils.isEmpty(a2)
                    || TextUtils.isEmpty(a3) || TextUtils.isEmpty(a4) || TextUtils.isEmpty(a5) || TextUtils.isEmpty(a6)) {

                Toast.makeText(activity, "请输入完整", Toast.LENGTH_SHORT)
            } else {
                var sentence = "$a1,$a2,$a3,$a4,$a5,$a6"
                var subtitles = Subtitles("dagong", sentence, "simple")
